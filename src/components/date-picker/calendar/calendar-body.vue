<template>
  <div class="calendar-body pt-3">
    <table class="table" width="100%" role="calendar-days">
      <thead>
        <tr class="calendar-weekdays" role="calendar-days-header">
          <th class="p-0 border-0">Dom</th>
          <th class="p-0 border-0">Seg</th>
          <th class="p-0 border-0">Ter</th>
          <th class="p-0 border-0">Qua</th>
          <th class="p-0 border-0">Qui</th>
          <th class="p-0 border-0">Sex</th>
          <th class="p-0 border-0">Sáb</th>
        </tr>
      </thead>
      <tbody>
